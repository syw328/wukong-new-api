...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/platform-catalog", middleware.HeaderNavModulePublicOrUserAuth("pricing"), controller.GetPlatformCatalog)
		apiRouter.POST("/platform-model-prices", middleware.HeaderNavModulePublicOrUserAuth("pricing"), anonymousRequestBodyLimit, controller.PostPlatformModelPrices)
		apiRouter.GET("/platform-media-template", middleware.RootAuth(), controller.GetPlatformMediaTemplate)
		apiRouter.GET("/platform-model-insights", middleware.HeaderNavModulePublicOrUserAuth("pricing"), controller.GetPlatformModelInsights)
