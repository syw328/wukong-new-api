...
import { portalLocalStorage, portalApiOrigin } from '@/lib/portal-runtime'
...
function getSavedSetupGuideExpanded(): boolean | null {
  ...
  const saved = portalLocalStorage.getItem(SETUP_GUIDE_VISIBILITY_STORAGE_KEY)
